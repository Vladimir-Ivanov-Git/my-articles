...
Клиент принимает наш DHCPACK и в качетсве шлюза по умолчанию и DNS-сервера выставяет наш IP-адрес **192.168.1.172**, а DHCPNAK от точки доступа присланный на 3 секунды позже просто проигнорирует.
